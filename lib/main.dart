  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Column(
          children: [
            // kotakUji(Colors.amber, 150, 'Normal'),
            // kotakUji(Colors.green, 100, 'Expanded'),
            // kotakUji(Colors.blue, 200, 'Normal'),
            // kotakUji(Colors.amber, 150, 'Normal'),
            // Flexible(
            //   fit: FlexFit.tight,
            //   flex: 1,
            //   child: kotakUji(Colors.green, 100, 'Flexible'),
            // ),
            // Expanded(flex: 1, child: kotakUji(Colors.blue, 250, 'Expanded')),
            kotakUji(Colors.amber, 150, 'Normal'),
            Flexible(
              fit: FlexFit.loose,
              flex: 1,
...
Container kotakUji(Color warna, double tinggi, String teks) {
  return Container(
